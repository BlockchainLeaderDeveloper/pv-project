...
function OhmMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="MainStreem" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>MainStreem</Typography>
      </Button>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("MainStreem", WAND_ADDRESS)}>
                        <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">MainStreem </Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sMainStreem", SWAND_ADDRESS)}>
                      <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sMainStreem</Typography>
                      </Button>
                    </Box>
                  </Box>
                ) : null}
