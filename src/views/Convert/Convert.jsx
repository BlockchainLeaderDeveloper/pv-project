              ...
              {!convertIsClose ? (
                ...
                <Grid item>
                  <div className="card-header">
                    ...
                    <Typography variant="h5">Soon you will be able to farm and earn HOMDAO!</Typography>
                ...
                {/* <div className="staking-area">
                  {!address ? (
                    <div className="stake-wallet-notification">
                      ...
                      <Typography variant="h6">Connect your wallet to convert MSM token</Typography>
                    </div>
                  ) : (
                    <>
                        ...
                        <Box className="stake-action-row " display="flex" alignItems="center">
                            ...
                            (!hasAllowance("presalePD") && view === 0) ? (
                              <Box className="help-text">
                                <Typography variant="body1" className="stake-note" color="textSecondary">
                                    <>
                                      First time converting to <b>MSM</b>?
                                      <br />
                                      Please approve MainStreem Finance to use your <b>PD</b> to convert MSM
                                    </>
                                </Typography>
                              </Box>
                            ) : (
                          ...
                          <TabPanel value={view} index={0} className="stake-tab-panel">
                            {isAllowanceDataLoading ? (
                              ...
                              >
                                {txnButtonText(pendingTransactions, "converting", "Convert MSM")}
                              </Button>
                            ) : (
                              <Button
                                className="stake-button"
                      ...
                      <div className={`stake-user-data`}>
                        ...
                        <div className="data-row">
                          <Typography variant="body1">Your MSM Token Balance</Typography>
                          <Typography variant="body1">
                            {isAppLoading ? <Skeleton width="80px" /> : <>{trim(ohmBalance, 4)} MSM</>}
                          </Typography>
                        </div>
                      </div>
                    </>
